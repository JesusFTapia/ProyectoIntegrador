...
//          User usuario=userService.registerNewUser(new User("Admin", "Jesús", "Pedro2"));
        ...
        clientService.registerNewClient(new Client("Jesús", "Tapia", "1625551234"));
        ...
        materialService.registerNewMaterial(new Material("Vinil rojo", "Material rojo de vinil adhesivo", 100, "m", 120.0f));
        materialService.registerNewMaterial(new Material("Vinil negro", "Material negro de vinil adhesivo", 100, "m", 150.0f));
        materialService.registerNewMaterial(new Material("Pintura negra perlada", "Pintura con perla de color azul para dar un brillo mas bonito", 2, "litro", 200.0f));
